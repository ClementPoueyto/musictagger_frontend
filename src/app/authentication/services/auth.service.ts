...
import { LoginRequest, LoginResponse, RefreshTokenRequest, RefreshTokenResponse, RegisterRequest, RegisterResponse } from '../interfaces';
...
export class AuthService {
  ...
  */
  login(loginRequest: LoginRequest): Observable<LoginResponse> {
    ...
    return this.http.post<LoginResponse>(this.API_URL+'auth', loginRequest).pipe(
      catchError(() => {
  ...
  */
  register(registerRequest: RegisterRequest): Observable<RegisterResponse> {
    ...
    return this.http.post<RegisterResponse>(this.API_URL+'users', registerRequest).pipe(
      catchError(() => {
  ...
  RefreshToken(refreshTokenRequest : RefreshTokenRequest) : Observable<RefreshTokenResponse>{
    ...
    return this.http.get<RefreshTokenResponse>(this.API_URL+'auth/refresh-token', {headers : headers}).pipe(
      catchError(() => {
