...
export class TagService extends CommonService {
  ...
  async searchTaggedTrack(searchTaggedTrackRequest: SearchTaggedTrackRequest): Promise<SearchTaggedTrackResponse> {
    ...
    const res = await firstValueFrom(this.http.get<SearchTaggedTrackResponse>(this.apiConfiguration.api_url + 'tags?userId=' + this.userService.getUserId()
  ...
  async getLikeTaggedTrack(likeTaggedTrackRequest: LikeTaggedTrackRequest): Promise<LikeTaggedTrackResponse> {
    ...
    const res = await firstValueFrom(this.http.get<LikeTaggedTrackResponse>(this.apiConfiguration.api_url + 'tags/like?userId=' + this.userService.getUserId()
  ...
  async getTaggedTrackByTrackId(getTaggedTrackRequest: GetTaggedTrackByTrackIdRequest): Promise<TaggedTrack> {
    ...
    const res = await firstValueFrom(this.http.get<TaggedTrack>(this.apiConfiguration.api_url + 'tags/tracks/' + getTaggedTrackRequest.trackId + '?userId=' + this.userService.getUserId()));
    return res;
  }
  ...
  async addTag(addTagRequest: TagRequest): Promise<TaggedTrack> {
    ...
    const res = await firstValueFrom(this.http.post<TaggedTrack>(this.apiConfiguration.api_url + 'tags?userId=' + this.userService.getUserId()
      , addTagRequest.body,
    )
    );
    return res;
  ...
  async deleteTag(deleteTagRequest: TagRequest): Promise<TaggedTrack> {
    ...
    const res = await firstValueFrom(this.http.delete<TaggedTrack>(this.apiConfiguration.api_url + 'tags?userId=' + this.userService.getUserId()
      , {
