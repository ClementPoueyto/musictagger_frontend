...
export class SearchComponent implements OnInit, OnDestroy {
  ...
  onChipChange($event: any) {
    ...
    this.getData({ key: this.selectedChip, request: { page: 0, limit: 50, query: this.query, tags: this.tags } })
  ...
  handlePaginatorEvent($event: PageEvent) {
    ...
    this.getData({ key: this.selectedChip, request: { page: $event.pageIndex, limit: $event.pageSize, query: this.query, tags: this.tags } })
  ...
  onFilterChange() {
    this.getData({ key: this.selectedChip, request: { page: 0, limit: this.metadata.limit, query: this.query, tags: this.tags } });
  }
}
